...
const DeleteButton = ({ serviceId }: { serviceId: string }) => {
  ...
  const deleteService = api.adminRoute.service.delete.useMutation({
    async onSuccess() {
      toast("Success", {
        description: "Success deleting service",
      });
